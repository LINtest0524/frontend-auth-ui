...
export default function EcpayPaymentPage() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (cartDataStr) {
        // 這裡需要重新載入購物車資料，但由於我們在不同頁面，
        // 最好的做法是重導向到購物車並顯示錯誤訊息
        sessionStorage.setItem('checkoutError', '付款處理失敗，請重新嘗試')
