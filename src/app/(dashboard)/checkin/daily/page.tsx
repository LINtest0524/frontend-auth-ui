    ...
    <div className="checkin-container fade-in">
      <div className="checkin-header">
        <div className="checkin-header-content">
          <h1>
            每日簽到活動
            <span className="activity-type-badge daily-calendar">日曆簽到</span>
          </h1>
          <p>管理每日日曆簽到活動，按照日曆格式展示，用戶可選擇任意日期簽到領取獎勵</p>
        </div>
        <Link href="/checkin/daily/new" className="checkin-add-btn">
          新增每日簽到活動
        </Link>
      </div>
                ...
                activities.map((activity, index) => (
                  <tr key={activity.id} className="table-row-enter" style={{ animationDelay: `${index * 0.1}s` }}>
                    <td>
                      ...
                      <div className="activity-subtitle">每日簽到活動 • 日曆式簽到領取獎勵</div>
                    </td>
                    <td>
